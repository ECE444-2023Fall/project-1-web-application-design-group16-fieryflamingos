...
class Event(Document):
    ...
    @staticmethod
    def get_events_regular(id_list):
        return Event.objects(id__in=id_list).order_by("+event_date.from_date").exclude("organizer", "location", "attendees", "description", "targeted_preferences")

    @staticmethod
    def get_events_organizer(org_id):
        return Event.objects(organizer__author_id=org_id).order_by("+event_date.from_date").exclude("organizer", "location", "attendees", "description", "targeted_preferences")
